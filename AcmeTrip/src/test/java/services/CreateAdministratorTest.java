...
public class CreateAdministratorTest extends AbstractTest{
	...
	public static Collection<Object[]> data() {
		...
		return Arrays.asList(new Object[][] {
				...
				{ "userprueba", "userprueba", "admin", "Pepe", "Perez", "+34696685547", "pepe@pepe.pep"},
	...
	public CreateAdministratorTest(String password, String passwordRepeat, String username, String name, String surname, String phone, String email){
	 ...
	 * En el primer caso probamos crear un admin con las contraseñas diferentes(fallido)
