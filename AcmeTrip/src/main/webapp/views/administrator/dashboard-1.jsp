...
<p>
	<jstl:out value="${totalNumberUsers}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${totalTripsRegistered}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${averageTripsPerUser}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${desviationTripsUser}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${averageDailyplansPerTrip}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${desviationDailyplansTrip}"></jstl:out>
</p>
...
<br>
<display:table name="users80percent" id="row1"
...
<br>
<display:table name="usersInactive" id="row1"
	requestURI="dashboard/administrator/list.do" pagesize="5"
	class="displaytag" keepStatus="true">
	...
	<display:column property="phone" title="${phone}" sortable="true" />
	<spring:message code="user.lastLogin" var="lastLogin" />
	<display:column property="lastLogin" title="${lastLogin}"
...
<p>
	<jstl:out value="${minimum}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${maximum}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${average}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${averageAmount}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${averageCampaignsLast}"></jstl:out>
</p>
...
<p>
	<jstl:out value="${standardDesviationCampaignsLast}"></jstl:out>
</p>
...
<br>
<display:table name="managersMoreCampaigns" id="row3"
	requestURI="dashboard/administrator/list.do" pagesize="5"
	class="displaytag" keepStatus="true">
	<spring:message code="user.name" var="name" />
	<display:column property="name" title="${name}" sortable="true" />
...
<br>
<display:table name="banners10MoreAverage" id="row3"
	requestURI="dashboard/administrator/list.do" pagesize="5"
	class="displaytag" keepStatus="true">
	<spring:message code="campaign.photo" var="photo" />
	<display:column title="${photo}" sortable="true">
		<img width="500px" height="100px" src="${row3.getPhoto()}" />
	</display:column>
</display:table>
...
<br>
<display:table name="banners10LessAverage" id="row4"
	requestURI="dashboard/administrator/list.do" pagesize="5"
	class="displaytag" keepStatus="true">
	<spring:message code="campaign.photo" var="photo" />
	<display:column title="${photo}" sortable="true">
		<img width="500px" height="100px" src="${row4.getPhoto()}" />
	</display:column>
</display:table>
